...
def train(layers, features, device,
    ...
    for epoch in range(1, num_epochs+1):
        ...
        for input_batch, target_batch in tqdm(train_loader):
            ...
            mse = loss_function(input_batch, target_batch)
            ...
            loss_stats["pred_target"].append(loss.item())
            loss_stats["input_target"].append(mse.item())
    ...
    run = {
        ...
        'pred_target': loss_stats["pred_target"],
        'input_target': loss_stats["input_target"],
